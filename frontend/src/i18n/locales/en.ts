export default {
  ...
  admin: {
    ...
    usage: {
      ...
      recordsTab: 'Usage Records',
      userSummary: {
        tab: 'User Summary',
        title: 'User Usage Summary',
        description: 'Detailed per-user usage and cost analysis for the selected range.',
        totalUsers: 'Users',
        costDistribution: 'Cost Distribution',
        requestDistribution: 'Request Distribution',
        tokenDistribution: 'Token Distribution',
        costComparison: 'Cost Comparison',
        costDistributionHint: 'Top spenders with the long tail grouped.',
        topUsersHint: 'Top 20 users in the selected range.',
        tokenDistributionHint: 'Token volume in millions.',
        costComparisonHint: 'Actual cost by top users.',
        tableTitle: 'User Usage Details',
        margin: 'Margin',
        share: 'Share',
        dateRange: 'Date Range',
        ...
        limitLabel: 'User summary row limit',
        empty: 'No user usage data in the selected range.',
        loadFailed: 'Failed to load user usage summary.'
      },
      userFilter: 'User',
