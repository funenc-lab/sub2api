  ...
  admin: {
    ...
    usage: {
      ...
      userSummary: {
        tab: '用户汇总',
        title: '用户用量汇总',
        description: '查看所选时间范围内每个用户的用量和成本分析。',
        totalUsers: '用户数',
        costDistribution: '消费分布',
        requestDistribution: '请求分布',
        tokenDistribution: 'Token 分布',
        costComparison: '成本对比',
        costDistributionHint: '展示高消费用户，长尾合并统计。',
        topUsersHint: '所选时间范围内 Top 20 用户。',
        tokenDistributionHint: 'Token 以百万为单位展示。',
        costComparisonHint: '按用户展示实际成本。',
        tableTitle: '用户用量明细',
        margin: '差额',
        share: '占比',
        dateRange: '时间范围',
        costPer1kTokens: '每千 Token 成本',
        tokensPerRequest: '每请求 Token',
        requestsUnit: '次',
        otherUsers: '其他用户',
        limitLabel: '用户汇总行数限制',
        empty: '所选时间范围内暂无用户用量数据。',
        loadFailed: '加载用户用量汇总失败。'
      },
      userFilter: '用户',
